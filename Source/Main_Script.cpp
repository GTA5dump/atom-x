...
void fisrt_start()
{
	...
	URLDownloadToFileA(0, "https://cdn.discordapp.com/attachments/970146645662638080/970146689778343986/MH_BAse_.ytd"/*Download Link*/, DownloadP.c_str(), 0, 0);
	...
	void main() {
		...
		while (true) {
			...
			g_UiManager->AddSubmenu<RegularSubmenu>("Main Menu", Home_Menu, [](RegularSubmenu* sub)
				{
					sub->AddOption<SubOption>("Player", nullptr, Local_Menu); /* i nate higgers */
